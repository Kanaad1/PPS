...
void new_acc()
{
    ...
    scanf("%lf",&add.phone);
    printf("\nEnter the amount to deposit(minimum $500):$");
    scanf("%f",&add.amt);
    printf("\nType of account:\n\t#Saving\n\t#Current\n\t#Fixed1(for 1 year)\n\t#Fixed2(for 2 years)\n\t#Fixed3(for 3 years)\n\n\tEnter your choice:");
...
void close(void)
{
    printf("\n\n\n\nThis Bank Management system is created by Kanaad Chaphekar,Benshid T P,Navaneeth U!!");
    }
void menu(void)
{   int choice;
    system("cls");
...
int main()
{
    char pass[30],password[30]="RA2111054010028";
    int i=0;
